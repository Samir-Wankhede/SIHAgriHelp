        ...
        {   !resp?
            <div className=" absolute h-[80vh] md:h-[60vh] w-[95vw] md:w-[80vw] bg-white rounded-lg grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1">
                ...
                <div className="col-span-1 h-full w-full bg-green-400 flex flex-col justify-center items-center p-2 md:p-8 rounded-lg">
                    ...
                    <div className="relative">
                        <button disabled={!Img} onClick={handleSubmit} className="w-full bg-white rounded-lg text-green-400 px-8 py-4 my-5"> Find Health! </button>
                    </div>
                    <div className="relative">
                        <input onChange={(e)=>setPlant(e.target.value)} placeholder="Enter plant name" className="w-full bg-white rounded-lg text-green-400 px-8 py-4 my-5"/>
                    </div>
                </div>
            </div>
            :
